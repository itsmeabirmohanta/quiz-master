-- Schema for Quiz Master Application

-- Enable Row Level Security
alter database postgres set "anon.jwt.secret" to 'fx4HUZpRA+4cIA9FMioUicSk0pcgcfDnhZK4+kZyF/BxURhVwo4vxCWXOzqHXKbIwf6E6rQQFAfeUg854Lzq7w==';
